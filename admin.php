			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" onsubmit="return validation()" method="POST" >		<span class="login100-form-title p-b-59">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid no. is required">
						...
						<input id="mobile"  class="input100" type="text" name="mobile" placeholder="+91 included">
						<span class="focus-input100"></span>
...
if(isset($_POST['submit'])){
	...
	if($emailcount>0){
 	...
 	?>
 	<script>alert('This email id is already used by another account');</script>
 	<?php 

	}else{


	$insertquery = " insert into admin(fname, email, mobile, username, password) values('$name', '$email', '$mobile_no', '$username', '$pass') ";
