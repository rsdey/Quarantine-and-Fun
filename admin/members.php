...
<br><br>
  <div class="main-div">
    <h1>List of Community members</h1><br>
    <h1>
      ...
      while ($result = mysqli_fetch_assoc($query)) {
        ...
        ?>
            ...
            <tr>
              ...
              <td><?php echo $result['insta']; ?></td>
              <td><?php echo $result['linkedin']; ?></td>
              <td><a href="updateinfo.php?id=<?php echo $result['id']; ?>"><i class="fa fa-edit"></i></a></td>
              <td><a href="../delete.php?id=<?php echo $result['id']; ?>"><i class="fa fa-trash" aria-hidden="true">
