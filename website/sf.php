...
<main role="main">
  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      <h4 class="mb-3">Any Suggestion or Appreciation :)</h4>
...
if(isset($_POST['submit'])){
  ...
  $insertquery = " insert into suggestion(username, email, comment) values('$username', '$email', '$comment') ";
  ...
  ?>
  <script>alert('Suggestion Submitted!');
  ...
  ?>
  <script>alert('Submission unsuccessful');</script>
  <?php
}
